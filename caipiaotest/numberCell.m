...
@synthesize zhiXuanLabel;
@synthesize selectNumberArray;
@synthesize delegate;

- (void)dealloc
{
    [selectNumberArray release];
    [super dealloc];
}
...
- (void)addBallHighlight:(NSInteger)SeleteNumber withLocation:(CGPoint)location
{
    ...
    [_lableNumberBackground release];
